                                ...
                                <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                 @csrf
                                    ...
                                    <div class="form-group @error('RW') has-error @enderror">
                                       ...
                                       <input type="text" class="form-control" name="RW" value="{{ old('RW') ?? $alamat == null ? '' : $alamat->RW }}"  placeholder="Masukan RW">
                                       @error('RW')
                                       <span class="help-block">{{ $message }}</span>
                                         @enderror
                                     </div>
                                    <div class="form-group @error('dusun') has-error @enderror">
                                      ...
                                      <input type="text" class="form-control " name="dusun" value="{{ old('dusun') ?? $alamat == null ? '' :$alamat->dusun }}"  placeholder="Masukan Dusun">
                                      @error('dusun')
                                      <span class="help-block">{{ $message }}</span>
                                         @enderror
                                    ...
                                    <div class="form-group @error('desa') has-error @enderror">
                                     ...
                                     <input type="text" class="form-control " name="desa"  value="{{ old('desa') ?? $alamat == null ? '' : $alamat->desa }}" placeholder="Masukan Desa">
                                     @error('desa')
                                     <span class="help-block">{{ $message }}</span>
                                     @enderror
                                   ...
                                   <div class="form-group @error('kecamatan') has-error @enderror ">
                                     ...
                                     <input type="text" class="form-control " name="kecamatan" value="{{ old('kecamatan') ?? $alamat == null ? '' : $alamat->kecamatan }}" placeholder="Masukan Kecamatan">
                                     @error('kecamatan')
                                     <span class="help-block">{{ $message }}</span>
                                   ...
                                   <div class="form-group @error('kabupaten') has-error @enderror ">
                                    ...
                                    <input type="text" class="form-control " name="kabupaten" value="{{ old('kabupaten') ?? $alamat == null ? '' : $alamat->kabupaten}}" placeholder="Masukan Kabupaten">
                                    @error('kabupaten')
                                    <span class="help-block">{{ $message }}</span>
                                  ...
                                  <div class="form-group @error('Provinsi') has-error @enderror ">
                                    ...
                                    <input type="text" class="form-control " name="provinsi" value="{{ old('Provinsi') ?? $alamat == null ? '' : $alamat->provinsi }}" placeholder="Masukan Provinsi">
                                    @error('Provinsi')
                                    <span class="help-block">{{ $message }}</span>
                                  ...
                                  <div class="form-group @error('jalan') has-error @enderror ">
                                    ...
                                    <input type="text" class="form-control " name="jalan" value="{{ old('jalan') ?? $alamat == null ? '' : $alamat->jalan }}" placeholder="Masukan Nama Jalan">
                                    @error('jalan')
                                    <span class="help-block">{{ $message }}</span>
                            ...
                            <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                @csrf
                                   <div class="form-group @error('nisn') has-error @enderror">
                                     ...
                                     <input type="number" class="form-control " value="{{ old('nisn') ?? $lulusan == null ? '' : $lulusan->nisn }}"  name="nisn" placeholder="Masukan Nisn">
                                     @error('nisn')
                                     <span class="help-block">{{ $message }}</span>
                                    @enderror
                                   </div>
                                   <div class="form-group @error('name') has-error @enderror">
                                      ...
                                      <input type="number" class="form-control" name="tahun_lulus" value="{{ old('tahun_lulus') ?? $lulusan == null ? '' : $lulusan->tahun_lulus }}"  placeholder="Masukan Tahun Lulus">
                                      @error('tahun_lulus')
                                      <span class="help-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                   <div class="form-group @error('asal_sekolah') has-error @enderror">
                                     ...
                                     <input type="text" class="form-control " name="asal_sekolah" value="{{ old('asal_sekolah') ?? $lulusan == null ? '' : $lulusan->asal_sekolah}}"  placeholder="Masukan Asal Sekolah">
                                     @error('asal_sekolah')
                                     <span class="help-block">{{ $message }}</span>
                                        @enderror
                                   ...
                                   <div class="form-group @error('npsn') has-error @enderror">
                                    ...
                                    <input type="number" class="form-control " name="npsn"  value="{{ old('npsn') ?? $lulusan == null ? '' : $lulusan->npsn}}" placeholder="Masukan NPSN">
                                    @error('npsn')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                            ...
                            <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                @csrf
                                   <div class="form-group @error('rencana') has-error @enderror">
                                     ...
                                     <input type="text" class="form-control " value="{{ old('rencana') ?? $rencana == null ? '' : $rencana->rencana_tinggal}}"  name="rencana_tinggal" placeholder="Masukan Rencana Tinggal">
                                     @error('rencana')
                                     <span class="help-block">{{ $message }}</span>
                                    @enderror
                                   </div>
                                   <div class="form-group @error('transport') has-error @enderror">
                                      ...
                                      <input type="text" class="form-control" name="transport" value="{{ old('transport') ?? $rencana == null ? '' : $rencana->transport }}"  placeholder="Masukan Transport">
                                      @error('transport')
                                      <span class="help-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                   <div class="form-group @error('jarak_tempuh') has-error @enderror">
                                     ...
                                     <input type="text" class="form-control " name="jarak_tempuh" value="{{ old('jarak_tempuh') ?? $rencana == null ? '' : $rencana->jarak_tempuh }}"  placeholder="Masukan Jarak Tempuh">
                                     @error('jarak_tempuh')
                                     <span class="help-block">{{ $message }}</span>
                                        @enderror
                                   ...
                                   <div class="form-group @error('asal_pembiayaan') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control " name="asal_pembiayaan"  value="{{ old('asal_pembiayaan') ?? $rencana == null ? '' : $rencana->asal_pembiayaan }}" placeholder="Masukan Asal Pembiayaan">
                            ...
                            <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                @csrf
                                   <div class="form-group @error('noKK') has-error @enderror">
                                     ...
                                     <input type="number" class="form-control " value="{{ old('noKK') }}"  name="noKK" placeholder="Masukan Nomor KK">
                                     @error('noKK')
                                     <span class="help-block">{{ $message }}</span>
                                    @enderror
                                   </div>
                                   <div class="form-group @error('nama_kk') has-error @enderror">
                                      ...
                                      <input type="text" class="form-control" name="nama_kk" value="{{ old('nama_kk') }}"  placeholder="Masukan Nama Kepala Keluarga">
                                      @error('nama_kk')
                                      <span class="help-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                   <div class="form-group @error('kip') has-error @enderror">
                                     ...
                                     <input type="file" class="form-control " name="kip" value="{{ old('kip') }}"  placeholder="Masukan Tempat lahir">
                                     @error('kip')
                                     <span class="help-block">{{ $message }}</span>
                                        @enderror
                                   ...
                                   <div class="form-group @error('kks') has-error @enderror">
                                    ...
                                    <input type="file" class="form-control " name="kks"  value="{{ old('kks') }}" placeholder="Masukan Tempat lahir">
                                    @error('kks')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                  ...
                                  <div class="form-group @error('pkh') has-error @enderror">
                                    ...
                                    <input type="file" class="form-control " name="pkh"  value="{{ old('pkh') }}" placeholder="Masukan Tempat lahir">
                                    @error('pkh')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
