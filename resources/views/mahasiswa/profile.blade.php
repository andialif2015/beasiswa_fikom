            ...
            <div class="box-body">
                   ...
                   <form action="{{ route('update.profile.mahasiswa',$profile->id) }}" method="post">
                    ...
                    <div class="form-group @error('nisn') has-error @enderror">
                      ...
                      <input type="text" class="form-control" name="nisn" value="{{ old('nisn',$profile->nisn) }}" placeholder="Masukan nisn">
                      @error('nisn')
                      <span class="help-block">{{ $message }}</span>
                       ...
                       <div class="form-group @error('name') has-error @enderror">
                        ...
                        <div class="form-group @error('tempat_lahir') has-error @enderror">
                          ...
                          <input type="text" class="form-control " name="tempat_lahir" value="{{ old('tempat_lahir',$profile->mahasiswa->tempat_lahir) }}"  placeholder="Masukan Tempat lahir">
                          @error('tempat_lahir')
                          <span class="help-block">{{ $message }}</span>
                             @enderror
                        ...
                        <div class="form-group @error('tanggal_lahir') has-error @enderror">
                         ...
                         <input type="date" class="form-control " name="tanggal_lahir" value="{{ old('tanggal_lahir',$profile->mahasiswa->tanggal_lahir) }}" placeholder="Masukan Tempat lahir">
                         @error('tanggal_lahir')
                         <span class="help-block">{{ $message }}</span>
                         @enderror
                       ...
                       <div class="form-group @error('phone') has-error @enderror ">
                         ...
                         <input type="number" class="form-control " name="phone" value="{{ old('phone',$profile->mahasiswa->phone) }}" placeholder="Masukan Tempat lahir">
                         @error('phone')
                         <span class="help-block">{{ $message }}</span>
